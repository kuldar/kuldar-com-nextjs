        ...
        {experiments.map((experiment, i) => {
          return (
            <a
              ...
              key={experiment.name}
              className="group/card relative col-span-6 overflow-hidden rounded-2xl border border-gray-500 bg-gray-1000 bg-gradient-to-br from-gray-900 via-gray-1000 to-gray-800 transition-colors hover:border-gray-200/70 active:top-[1px] last:max-[1104px]:col-span-6 md:col-span-3 min-[1104px]:col-span-2 xl:col-span-6"
            >
              {/* Experiment */}
              <div className="flex items-center justify-between space-x-4 bg-gray-1000 p-6 pr-8 transition-colors hover:bg-transparent">
                <div>
