...
export const article = {
  ...
  date: '2023-08-08',
  title: 'Scraping the web with Supabase Edge Functions',
  description:
    'Most companies try to stay ahead of the curve when it comes to visual design, but for Planetaria we needed to create a brand that would still.',
}
...
export const metadata = {
  ...
  openGraph: {
    images: meta.website.url + '/articles/og',
    type: 'article',
  },
}
