...
import webIdeas from './web-ideas.png'
import webWireframe from './web-wireframe.png'

export const work = {
  title: 'Branding & Marketing Website for A-Barber',
  description:
  ...
  client: {
    name: 'A-Barber',
    website: 'https://a-barber.ee',
    illustration: Illustrations.Barber,
    illustrationPosition: '-top-14 -right-44',
  },
}
...
<Image src={webWireframe} alt="Some progess" />
