...
export const work = {
  ...
  details:
    'Align helps B2B product teams with AI-powered insight detection and trend recognition. I had a chance to help them develop an initial identity concept, design and build a marketing page as well as some work on UI details.',
  client: {
    name: 'Align',
    website: 'https://getalign.com',
    illustration: Illustrations.Align,
    illustrationPosition: '-top-6 -right-4',
  },
}
